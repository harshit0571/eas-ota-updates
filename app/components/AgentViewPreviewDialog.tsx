            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="text-xs text-amber-700 mt-1">
                  If a vehicle with the same number already exists in the
                  system, it will be updated with the latest information from
                  this file. New vehicles will be added as usual.
                </p>
              </div>
            </div>
          </div>
